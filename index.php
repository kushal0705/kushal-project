    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://source.unsplash.com/3200x800/?school" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="https://source.unsplash.com/3200x800/?education" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="https://source.unsplash.com/3200x800/?party" class="d-block w-100" alt="...">
            </div>
        </div>
            ...
            <?php
                ...
                while($row = mysqli_fetch_assoc($result)){
                    ...
                    <div class="card gal--animation gal--part'.$courseid.'" style="width: 18rem;">
                        <img src="https://source.unsplash.com/2400x800/?'.$coursename.'" class="card-img-top" alt="...">
                        <div class="card-body">
